...
주식회사 vegetas(이하 “회사”라 함)는 「정보통신망 이용촉진 및 정보보호 등에 관한 법률」 등 개인정보와 관련된 법령에 따라 이용자의 개인정보를 보호하고 개인정보와 관련한 이용자의 고충을 원활하게 처리할 수 있도록 다음과 같은 처리방침을 두고 있습니다.
...
이용자가 1년 동안 vegetas에서 제공하는 서비스(웹사이트, 모바일 웹, 모바일 앱)를 이용한 기록이 없을 경우, 서비스 미이용자의 개인정보는 일반 이용자의 개인정보와 분리하여 별도로 저장 및 관리됩니다(휴면 계정으로 변경). 회사는 휴면계정으로 변경되는 시점 도래 30일 전에 해당 내용에 대해 이메일 등을 통해 이용자에게 공지합니다. 분리 저장된 개인정보는 관련 법령에 특별한 규정이 있는 경우를 제외하고 해당 개인정보를 이용하거나 제공하지 않으며, 관련 법령에 따라 일정 기간 동안 보유되고 해당기간 종료 후 파기됩니다. 다만 파기되지 않은 개인정보는 해당 이용자의 요청에 따라 서비스 이용을 재개하는 시점에서 다시 제공됩니다.
...
회원은 vegetas 어플리케이션을 이용하기 위하여 계정을 만들어야 합니다. 계정을 만들기 위해 제공되는 회원의 개인정보는 관련법과 당사의 개인보호 정책에 의하여 보호됩니다. 회원은 개인정보 변경 시 변경된 정보를 입력하여야 하며 계정의 보안과 기밀을 유지하기 위하여 노력합니다. vegetas는 적절한 이유가 있을 경우 회원의 계정을 폐쇄하거나 접속을 제한할 수 있습니다.
...
(1) '내용물' 이라 함은 문자, 그림, 사진, 동영상, 리뷰, 위치 및 기타 데이터 또는 모든 다른 형태의 송신 및 커뮤니케이션된 정보를 뜻합니다. vegetas에 있는 모든 내용물 (이하 ‘서비스 내용물’ 이라 함)은 오직 서비스 이용 목적을 위해서만 회원에게 제공되며, 관련 지적재산권의 보호를 받습니다. 회원은 당사의 서면 승인 없이 서비스 내용물을 변경, 수집, 복제, 송신, 출판 (온라인, 오프라인 포함), 배포, 방송 기타 방법에 의하여 이용하거나 제3자에게 이용하게 하여서는 아니 됩니다.

(2) 서비스 내용물에는 회원 내용물, vegetas 내용물과 제3자 내용물이 모두 포함됩니다. '회원 내용물' 이라 함은 평점, 리뷰, 사진, 좋아요, 가고싶다, 체크인, 댓글, 이벤트 참여, 혹은 닉네임 등 프로필에 기재하는 정보 등 회원이 vegetas를 이용하면서 등록하거나 그 외 당사 서버에 송신하는 모든 내용물을 의미합니다. 'vegetas 내용물' 이라 함은 망고픽, 페이스북 포스팅, 기타 온라인 및 오프라인 제작물 등 vegetas가 직접 제작하는 내용물 혹은 당사 서버에 송신하거나 페이스북 페이지에 등록하는 모든 내용물을 의미합니다. '제3자 내용물' 이라 함은 회원 혹은 vegetas에게서 창조되거나 유래되는 내용물은 아니지만 vegetas 서비스를 통해 회원에게 제공되는 내용물을 의미합니다.

(3) vegetas 내용물에 대한 저작권 및 기타 지적 재산권은 당사에 귀속됩니다. 당사는 적절한 이유가 있을 경우 모든 서비스 내용물을 자의적으로 삭제, 수정, 편집, 복제 혹은 재등록 할 수 있습니다. 본 계약에서 달리 명시된 바를 제외하고 당사는 회원에게 어떠한 라이선스나 사용권도 부여하지 않습니다. 본 약관은 당사 또는 당사로부터 라이선스를 받은 자가 서비스 내용물이나 서비스에 대해 가지고 있는 권리, 또 이와 연관된 특허, 상표, 저작권 또는 다른 지적재산권에 영향을 주지 않습니다. 본 약관은 vegetas의 상표나 다른 제3자의 상표권과 관련 라이선스나 다른 권리를 부여하지 않습니다.

(4) 회원 (이하 '해당 회원'이라 함)가 직접 작성 및 등록한 평가점수, 리뷰, 답글, 사진 등의 게시물 (이하 '해당 회원 내용물'이라 함)에 대한 저작권 및 지적 재산권은 해당 회원에게 있으며, 해당 회원 내용물이 타인의 저작권을 침해하는 경우 그에 대한 책임은 해당 회원 본인이 부담합니다. 해당 회원은 당사에게 해당 회원 내용물을 독점적으로 이용할 수 있는 권리를 부여합니다. 이에 따라 당사는 vegetas 어플리케이션, 모바일 및 PC 웹사이트, 페이스북 페이지, 광고물, 검색노출, 판촉, 홍보 등의 기타 매체에 해당 회원 내용물을 무상으로 영구적으로 이용할 수 있으며, 필요한 범위 내에서 해당 회원 내용물의 일부를 수정, 복제 및 편집할 수 있습니다. 또한, 해당 회원은 당사가 커뮤니티 가이드라인 혹은 기타 당사 내부의 적절한 이유에 따라 언제든지 해당 회원 내용물을 삭제, 수정 혹은 재등록할 권한이 있음에 동의합니다. 단, 해당 회원은 해당 회원 내용물에 대하여 마케팅, 판촉, 홍보 및 기타 자료로 사용되지 않을 것을 요청할 수 있으며, vegetas 서비스 내의 기능을 이용하여 해당 회원 내용물을 수정 혹은 삭제할 수 있습니다.
...
(1) 로봇, 스파이더, 스크래퍼, 크롤러 또는 기타 자동 장치를, 당사의 서면 허가 없이 어떠한 목적으로든지 vegetas 어플리케이션, PC 및 모바일 웹사이트 및 서비스 내용물에 접근하는데 사용되는 프로세스 및 수단을 사용하지 않기로 동의합니다.

(2) vegetas의 기반 시설에 비합리적인 또는 비례에 맞지 않게 큰 부하를 가중시키거나 가중시킬 수 있는 (당사의 단독 재량 하에) 어떠한 조치도 취하지 않기로 동의합니다.
...
(목적) 본 약관은 회원(vegetas 서비스 약관에 동의한 자를 말합니다. 이하 "회원"이라고 합니다)이 (주)vegetas(이하 "회사"라고 합니다.)가 제공하는 vegetas 서비스(이하 "서비스"라고 합니다)를 이용함에 있어 회사와 회원의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.
...
제1조 (시행일) 이 약관은 2019년 2월 14일 부터 시행합니다.`}
          </Text>
        </ScrollView>
      </View>
    );
